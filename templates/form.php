  ...
  <div class="hessqf-step-panel active" id="hessqfStepPanel1">
    ...
    <div class="hessqf-card hessqf-tier-cards-section" id="hessqfTierCardsSection" style="display:none;">
      ...
      <div id="hessqfPackageSection" style="display:none;">
        <img src="<?php echo esc_url( HESSQF_URL . 'assets/images/hesserized-promo-system.png' ); ?>" alt="HESSeRized Promotional System" class="hessqf-hesserized-logo" style="display:block;margin:28px 0 6px;max-width:480px;height:auto;" />
        <div class="hessqf-card-title">Choose Your Value Package</div>
